...
* Copyright jQuery Foundation and other contributors; Licensed MIT */(function(s){typeof define=="function"&&define.amd?define(["jquery"],s):s(jQuery)})(function(s){s.ui=s.ui||{};var yt=s.ui.version="1.12.1";/*!
 ...
 */(function(){var t,e=Math.max,i=Math.abs,n=/left|center|right/,o=/top|center|bottom/,a=/[\+\-]\d+(\.[\d]+)?%?/,r=/^\w+/,l=/%$/,h=s.fn.position;function u(c,p,m){return[parseFloat(c[0])*(l.test(c[0])?p/100:1),parseFloat(c[1])*(l.test(c[1])?m/100:1)]}function d(c,p){return parseInt(s.css(c,p),10)||0}function g(c){var p=c[0];return p.nodeType===9?{width:c.width(),height:c.height(),offset:{top:0,left:0}}:s.isWindow(p)?{width:c.width(),height:c.height(),offset:{top:c.scrollTop(),left:c.scrollLeft()}}:p.preventDefault?{width:0,height:0,offset:{top:p.pageY,left:p.pageX}}:{width:c.outerWidth(),height:c.outerHeight(),offset:c.offset()}}s.position={scrollbarWidth:function(){if(t!==void 0)return t;var c,p,m=s("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),f=m.children()[0];return s("body").append(m),c=f.offsetWidth,m.css("overflow","scroll"),p=f.offsetWidth,c===p&&(p=m[0].clientWidth),m.remove(),t=c-p},getScrollInfo:function(c){var p=c.isWindow||c.isDocument?"":c.element.css("overflow-x"),m=c.isWindow||c.isDocument?"":c.element.css("overflow-y"),f=p==="scroll"||p==="auto"&&c.width<c.element[0].scrollWidth,_=m==="scroll"||m==="auto"&&c.height<c.element[0].scrollHeight;return{width:_?s.position.scrollbarWidth():0,height:f?s.position.scrollbarWidth():0}},getWithinInfo:function(c){var p=s(c||window),m=s.isWindow(p[0]),f=!!p[0]&&p[0].nodeType===9,_=!m&&!f;return{element:p,isWindow:m,isDocument:f,offset:_?s(c).offset():{left:0,top:0},scrollLeft:p.scrollLeft(),scrollTop:p.scrollTop(),width:p.outerWidth(),height:p.outerHeight()}}},s.fn.position=function(c){if(!c||!c.of)return h.apply(this,arguments);c=s.extend({},c);var p,m,f,_,v,b,y=s(c.of),w=s.position.getWithinInfo(c.within),D=s.position.getScrollInfo(w),k=(c.collision||"flip").split(" "),C={};return b=g(y),y[0].preventDefault&&(c.at="left top"),m=b.width,f=b.height,_=b.offset,v=s.extend({},_),s.each(["my","at"],function(){var x=(c[this]||"").split(" "),T,I;x.length===1&&(x=n.test(x[0])?x.concat(["center"]):o.test(x[0])?["center"].concat(x):["center","center"]),x[0]=n.test(x[0])?x[0]:"center",x[1]=o.test(x[1])?x[1]:"center",T=a.exec(x[0]),I=a.exec(x[1]),C[this]=[T?T[0]:0,I?I[0]:0],c[this]=[r.exec(x[0])[0],r.exec(x[1])[0]]}),k.length===1&&(k[1]=k[0]),c.at[0]==="right"?v.left+=m:c.at[0]==="center"&&(v.left+=m/2),c.at[1]==="bottom"?v.top+=f:c.at[1]==="center"&&(v.top+=f/2),p=u(C.at,m,f),v.left+=p[0],v.top+=p[1],this.each(function(){var x,T,I=s(this),P=I.outerWidth(),M=I.outerHeight(),A=d(this,"marginLeft"),E=d(this,"marginTop"),G=P+A+d(this,"marginRight")+D.width,X=M+E+d(this,"marginBottom")+D.height,O=s.extend({},v),S=u(C.my,I.outerWidth(),I.outerHeight());c.my[0]==="right"?O.left-=P:c.my[0]==="center"&&(O.left-=P/2),c.my[1]==="bottom"?O.top-=M:c.my[1]==="center"&&(O.top-=M/2),O.left+=S[0],O.top+=S[1],x={marginLeft:A,marginTop:E},s.each(["left","top"],function(Y,W){s.ui.position[k[Y]]&&s.ui.position[k[Y]][W](O,{targetWidth:m,targetHeight:f,elemWidth:P,elemHeight:M,collisionPosition:x,collisionWidth:G,collisionHeight:X,offset:[p[0]+S[0],p[1]+S[1]],my:c.my,at:c.at,within:w,elem:I})}),c.using&&(T=function(Y){var W=_.left-O.left,R=W+m-P,N=_.top-O.top,q=N+f-M,B={target:{element:y,left:_.left,top:_.top,width:m,height:f},element:{element:I,left:O.left,top:O.top,width:P,height:M},horizontal:R<0?"left":W>0?"right":"center",vertical:q<0?"top":N>0?"bottom":"middle"};m<P&&i(W+R)<m&&(B.horizontal="center"),f<M&&i(N+q)<f&&(B.vertical="middle"),e(i(W),i(R))>e(i(N),i(q))?B.important="horizontal":B.important="vertical",c.using.call(this,Y,B)}),I.offset(s.extend(O,{using:T}))})},s.ui.position={fit:{left:function(c,p){var m=p.within,f=m.isWindow?m.scrollLeft:m.offset.left,_=m.width,v=c.left-p.collisionPosition.marginLeft,b=f-v,y=v+p.collisionWidth-_-f,w;p.collisionWidth>_?b>0&&y<=0?(w=c.left+b+p.collisionWidth-_-f,c.left+=b-w):y>0&&b<=0?c.left=f:b>y?c.left=f+_-p.collisionWidth:c.left=f:b>0?c.left+=b:y>0?c.left-=y:c.left=e(c.left-v,c.left)},top:function(c,p){var m=p.within,f=m.isWindow?m.scrollTop:m.offset.top,_=p.within.height,v=c.top-p.collisionPosition.marginTop,b=f-v,y=v+p.collisionHeight-_-f,w;p.collisionHeight>_?b>0&&y<=0?(w=c.top+b+p.collisionHeight-_-f,c.top+=b-w):y>0&&b<=0?c.top=f:b>y?c.top=f+_-p.collisionHeight:c.top=f:b>0?c.top+=b:y>0?c.top-=y:c.top=e(c.top-v,c.top)}},flip:{left:function(c,p){var m=p.within,f=m.offset.left+m.scrollLeft,_=m.width,v=m.isWindow?m.scrollLeft:m.offset.left,b=c.left-p.collisionPosition.marginLeft,y=b-v,w=b+p.collisionWidth-_-v,D=p.my[0]==="left"?-p.elemWidth:p.my[0]==="right"?p.elemWidth:0,k=p.at[0]==="left"?p.targetWidth:p.at[0]==="right"?-p.targetWidth:0,C=-2*p.offset[0],x,T;y<0?(x=c.left+D+k+C+p.collisionWidth-_-f,(x<0||x<i(y))&&(c.left+=D+k+C)):w>0&&(T=c.left-p.collisionPosition.marginLeft+D+k+C-v,(T>0||i(T)<w)&&(c.left+=D+k+C))},top:function(c,p){var m=p.within,f=m.offset.top+m.scrollTop,_=m.height,v=m.isWindow?m.scrollTop:m.offset.top,b=c.top-p.collisionPosition.marginTop,y=b-v,w=b+p.collisionHeight-_-v,D=p.my[1]==="top",k=D?-p.elemHeight:p.my[1]==="bottom"?p.elemHeight:0,C=p.at[1]==="top"?p.targetHeight:p.at[1]==="bottom"?-p.targetHeight:0,x=-2*p.offset[1],T,I;y<0?(I=c.top+k+C+x+p.collisionHeight-_-f,(I<0||I<i(y))&&(c.top+=k+C+x)):w>0&&(T=c.top-p.collisionPosition.marginTop+k+C+x-v,(T>0||i(T)<w)&&(c.top+=k+C+x))}},flipfit:{left:function(){s.ui.position.flip.left.apply(this,arguments),s.ui.position.fit.left.apply(this,arguments)},top:function(){s.ui.position.flip.top.apply(this,arguments),s.ui.position.fit.top.apply(this,arguments)}}}})();var Ct=s.ui.position;/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var xt=s.extend(s.expr[":"],{data:s.expr.createPseudo?s.expr.createPseudo(function(t){return function(e){return!!s.data(e,t)}}):function(t,e,i){return!!s.data(t,i[3])}});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var kt=s.fn.extend({disableSelection:function(){var t="onselectstart"in document.createElement("div")?"selectstart":"mousedown";return function(){return this.on(t+".ui-disableSelection",function(e){e.preventDefault()})}}(),enableSelection:function(){return this.off(".ui-disableSelection")}});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var J="ui-effects-",$="ui-effects-style",tt="ui-effects-animated",lt=s;s.effects={effect:{}};/*!
 ...
 */(function(t,e){var i="backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",n=/^([\-+])=\s*(\d+\.?\d*)/,o=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(f){return[f[1],f[2],f[3],f[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(f){return[f[1]*2.55,f[2]*2.55,f[3]*2.55,f[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,parse:function(f){return[parseInt(f[1],16),parseInt(f[2],16),parseInt(f[3],16)]}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,parse:function(f){return[parseInt(f[1]+f[1],16),parseInt(f[2]+f[2],16),parseInt(f[3]+f[3],16)]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(f){return[f[1],f[2]/100,f[3]/100,f[4]]}}],a=t.Color=function(f,_,v,b){return new t.Color.fn.parse(f,_,v,b)},r={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},l={byte:{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},h=a.support={},u=t("<p>")[0],d,g=t.each;u.style.cssText="background-color:rgba(1,1,1,.5)",h.rgba=u.style.backgroundColor.indexOf("rgba")>-1,g(r,function(f,_){_.cache="_"+f,_.props.alpha={idx:3,type:"percent",def:1}});function c(f,_,v){var b=l[_.type]||{};return f==null?v||!_.def?null:_.def:(f=b.floor?~~f:parseFloat(f),isNaN(f)?_.def:b.mod?(f+b.mod)%b.mod:0>f?0:b.max<f?b.max:f)}function p(f){var _=a(),v=_._rgba=[];return f=f.toLowerCase(),g(o,function(b,y){var w,D=y.re.exec(f),k=D&&y.parse(D),C=y.space||"rgba";if(k)return w=_[C](k),_[r[C].cache]=w[r[C].cache],v=_._rgba=w._rgba,!1}),v.length?(v.join()==="0,0,0,0"&&t.extend(v,d.transparent),_):d[f]}a.fn=t.extend(a.prototype,{parse:function(f,_,v,b){if(f===e)return this._rgba=[null,null,null,null],this;(f.jquery||f.nodeType)&&(f=t(f).css(_),_=e);var y=this,w=t.type(f),D=this._rgba=[];if(_!==e&&(f=[f,_,v,b],w="array"),w==="string")return this.parse(p(f)||d._default);if(w==="array")return g(r.rgba.props,function(k,C){D[C.idx]=c(f[C.idx],C)}),this;if(w==="object")return f instanceof a?g(r,function(k,C){f[C.cache]&&(y[C.cache]=f[C.cache].slice())}):g(r,function(k,C){var x=C.cache;g(C.props,function(T,I){if(!y[x]&&C.to){if(T==="alpha"||f[T]==null)return;y[x]=C.to(y._rgba)}y[x][I.idx]=c(f[T],I,!0)}),y[x]&&t.inArray(null,y[x].slice(0,3))<0&&(y[x][3]=1,C.from&&(y._rgba=C.from(y[x])))}),this},is:function(f){var _=a(f),v=!0,b=this;return g(r,function(y,w){var D,k=_[w.cache];return k&&(D=b[w.cache]||w.to&&w.to(b._rgba)||[],g(w.props,function(C,x){if(k[x.idx]!=null)return v=k[x.idx]===D[x.idx],v})),v}),v},_space:function(){var f=[],_=this;return g(r,function(v,b){_[b.cache]&&f.push(v)}),f.pop()},transition:function(f,_){var v=a(f),b=v._space(),y=r[b],w=this.alpha()===0?a("transparent"):this,D=w[y.cache]||y.to(w._rgba),k=D.slice();return v=v[y.cache],g(y.props,function(C,x){var T=x.idx,I=D[T],P=v[T],M=l[x.type]||{};P!==null&&(I===null?k[T]=P:(M.mod&&(P-I>M.mod/2?I+=M.mod:I-P>M.mod/2&&(I-=M.mod)),k[T]=c((P-I)*_+I,x)))}),this[b](k)},blend:function(f){if(this._rgba[3]===1)return this;var _=this._rgba.slice(),v=_.pop(),b=a(f)._rgba;return a(t.map(_,function(y,w){return(1-v)*b[w]+v*y}))},toRgbaString:function(){var f="rgba(",_=t.map(this._rgba,function(v,b){return v??(b>2?1:0)});return _[3]===1&&(_.pop(),f="rgb("),f+_.join()+")"},toHslaString:function(){var f="hsla(",_=t.map(this.hsla(),function(v,b){return v==null&&(v=b>2?1:0),b&&b<3&&(v=Math.round(v*100)+"%"),v});return _[3]===1&&(_.pop(),f="hsl("),f+_.join()+")"},toHexString:function(f){var _=this._rgba.slice(),v=_.pop();return f&&_.push(~~(v*255)),"#"+t.map(_,function(b){return b=(b||0).toString(16),b.length===1?"0"+b:b}).join("")},toString:function(){return this._rgba[3]===0?"transparent":this.toRgbaString()}}),a.fn.parse.prototype=a.fn;function m(f,_,v){return v=(v+1)%1,v*6<1?f+(_-f)*v*6:v*2<1?_:v*3<2?f+(_-f)*(2/3-v)*6:f}r.hsla.to=function(f){if(f[0]==null||f[1]==null||f[2]==null)return[null,null,null,f[3]];var _=f[0]/255,v=f[1]/255,b=f[2]/255,y=f[3],w=Math.max(_,v,b),D=Math.min(_,v,b),k=w-D,C=w+D,x=C*.5,T,I;return D===w?T=0:_===w?T=60*(v-b)/k+360:v===w?T=60*(b-_)/k+120:T=60*(_-v)/k+240,k===0?I=0:x<=.5?I=k/C:I=k/(2-C),[Math.round(T)%360,I,x,y??1]},r.hsla.from=function(f){if(f[0]==null||f[1]==null||f[2]==null)return[null,null,null,f[3]];var _=f[0]/360,v=f[1],b=f[2],y=f[3],w=b<=.5?b*(1+v):b+v-b*v,D=2*b-w;return[Math.round(m(D,w,_+1/3)*255),Math.round(m(D,w,_)*255),Math.round(m(D,w,_-1/3)*255),y]},g(r,function(f,_){var v=_.props,b=_.cache,y=_.to,w=_.from;a.fn[f]=function(D){if(y&&!this[b]&&(this[b]=y(this._rgba)),D===e)return this[b].slice();var k,C=t.type(D),x=C==="array"||C==="object"?D:arguments,T=this[b].slice();return g(v,function(I,P){var M=x[C==="object"?I:P.idx];M==null&&(M=T[P.idx]),T[P.idx]=c(M,P)}),w?(k=a(w(T)),k[b]=T,k):a(T)},g(v,function(D,k){a.fn[D]||(a.fn[D]=function(C){var x=t.type(C),T=D==="alpha"?this._hsla?"hsla":"rgba":f,I=this[T](),P=I[k.idx],M;return x==="undefined"?P:(x==="function"&&(C=C.call(this,P),x=t.type(C)),C==null&&k.empty?this:(x==="string"&&(M=n.exec(C),M&&(C=P+parseFloat(M[2])*(M[1]==="+"?1:-1))),I[k.idx]=C,this[T](I)))})})}),a.hook=function(f){var _=f.split(" ");g(_,function(v,b){t.cssHooks[b]={set:function(y,w){var D,k,C="";if(w!=="transparent"&&(t.type(w)!=="string"||(D=p(w)))){if(w=a(D||w),!h.rgba&&w._rgba[3]!==1){for(k=b==="backgroundColor"?y.parentNode:y;(C===""||C==="transparent")&&k&&k.style;)try{C=t.css(k,"backgroundColor"),k=k.parentNode}catch{}w=w.blend(C&&C!=="transparent"?C:"_default")}w=w.toRgbaString()}try{y.style[b]=w}catch{}}},t.fx.step[b]=function(y){y.colorInit||(y.start=a(y.elem,b),y.end=a(y.end),y.colorInit=!0),t.cssHooks[b].set(y.elem,y.start.transition(y.end,y.pos))}})},a.hook(i),t.cssHooks.borderColor={expand:function(f){var _={};return g(["Top","Right","Bottom","Left"],function(v,b){_["border"+b+"Color"]=f}),_}},d=t.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(lt),function(){var t=["add","remove","toggle"],e={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};s.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(o,a){s.fx.step[a]=function(r){(r.end!=="none"&&!r.setAttr||r.pos===1&&!r.setAttr)&&(lt.style(r.elem,a,r.end),r.setAttr=!0)}});function i(o){var a,r,l=o.ownerDocument.defaultView?o.ownerDocument.defaultView.getComputedStyle(o,null):o.currentStyle,h={};if(l&&l.length&&l[0]&&l[l[0]])for(r=l.length;r--;)a=l[r],typeof l[a]=="string"&&(h[s.camelCase(a)]=l[a]);else for(a in l)typeof l[a]=="string"&&(h[a]=l[a]);return h}function n(o,a){var r={},l,h;for(l in a)h=a[l],o[l]!==h&&(e[l]||(s.fx.step[l]||!isNaN(parseFloat(h)))&&(r[l]=h));return r}s.fn.addBack||(s.fn.addBack=function(o){return this.add(o==null?this.prevObject:this.prevObject.filter(o))}),s.effects.animateClass=function(o,a,r,l){var h=s.speed(a,r,l);return this.queue(function(){var u=s(this),d=u.attr("class")||"",g,c=h.children?u.find("*").addBack():u;c=c.map(function(){var p=s(this);return{el:p,start:i(this)}}),g=function(){s.each(t,function(p,m){o[m]&&u[m+"Class"](o[m])})},g(),c=c.map(function(){return this.end=i(this.el[0]),this.diff=n(this.start,this.end),this}),u.attr("class",d),c=c.map(function(){var p=this,m=s.Deferred(),f=s.extend({},h,{queue:!1,complete:function(){m.resolve(p)}});return this.el.animate(this.diff,f),m.promise()}),s.when.apply(s,c.get()).done(function(){g(),s.each(arguments,function(){var p=this.el;s.each(this.diff,function(m){p.css(m,"")})}),h.complete.call(u[0])})})},s.fn.extend({addClass:function(o){return function(a,r,l,h){return r?s.effects.animateClass.call(this,{add:a},r,l,h):o.apply(this,arguments)}}(s.fn.addClass),removeClass:function(o){return function(a,r,l,h){return arguments.length>1?s.effects.animateClass.call(this,{remove:a},r,l,h):o.apply(this,arguments)}}(s.fn.removeClass),toggleClass:function(o){return function(a,r,l,h,u){return typeof r=="boolean"||r===void 0?l?s.effects.animateClass.call(this,r?{add:a}:{remove:a},l,h,u):o.apply(this,arguments):s.effects.animateClass.call(this,{toggle:a},r,l,h)}}(s.fn.toggleClass),switchClass:function(o,a,r,l,h){return s.effects.animateClass.call(this,{add:a,remove:o},r,l,h)}})}(),function(){s.expr&&s.expr.filters&&s.expr.filters.animated&&(s.expr.filters.animated=function(n){return function(o){return!!s(o).data(tt)||n(o)}}(s.expr.filters.animated)),s.uiBackCompat!==!1&&s.extend(s.effects,{save:function(n,o){for(var a=0,r=o.length;a<r;a++)o[a]!==null&&n.data(J+o[a],n[0].style[o[a]])},restore:function(n,o){for(var a,r=0,l=o.length;r<l;r++)o[r]!==null&&(a=n.data(J+o[r]),n.css(o[r],a))},setMode:function(n,o){return o==="toggle"&&(o=n.is(":hidden")?"show":"hide"),o},createWrapper:function(n){if(n.parent().is(".ui-effects-wrapper"))return n.parent();var o={width:n.outerWidth(!0),height:n.outerHeight(!0),float:n.css("float")},a=s("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),r={width:n.width(),height:n.height()},l=document.activeElement;try{l.id}catch{l=document.body}return n.wrap(a),(n[0]===l||s.contains(n[0],l))&&s(l).trigger("focus"),a=n.parent(),n.css("position")==="static"?(a.css({position:"relative"}),n.css({position:"relative"})):(s.extend(o,{position:n.css("position"),zIndex:n.css("z-index")}),s.each(["top","left","bottom","right"],function(h,u){o[u]=n.css(u),isNaN(parseInt(o[u],10))&&(o[u]="auto")}),n.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"})),n.css(r),a.css(o).show()},removeWrapper:function(n){var o=document.activeElement;return n.parent().is(".ui-effects-wrapper")&&(n.parent().replaceWith(n),(n[0]===o||s.contains(n[0],o))&&s(o).trigger("focus")),n}}),s.extend(s.effects,{version:"1.12.1",define:function(n,o,a){return a||(a=o,o="effect"),s.effects.effect[n]=a,s.effects.effect[n].mode=o,a},scaledDimensions:function(n,o,a){if(o===0)return{height:0,width:0,outerHeight:0,outerWidth:0};var r=a!=="horizontal"?(o||100)/100:1,l=a!=="vertical"?(o||100)/100:1;return{height:n.height()*l,width:n.width()*r,outerHeight:n.outerHeight()*l,outerWidth:n.outerWidth()*r}},clipToBox:function(n){return{width:n.clip.right-n.clip.left,height:n.clip.bottom-n.clip.top,left:n.clip.left,top:n.clip.top}},unshift:function(n,o,a){var r=n.queue();o>1&&r.splice.apply(r,[1,0].concat(r.splice(o,a))),n.dequeue()},saveStyle:function(n){n.data($,n[0].style.cssText)},restoreStyle:function(n){n[0].style.cssText=n.data($)||"",n.removeData($)},mode:function(n,o){var a=n.is(":hidden");return o==="toggle"&&(o=a?"show":"hide"),(a?o==="hide":o==="show")&&(o="none"),o},getBaseline:function(n,o){var a,r;switch(n[0]){case"top":a=0;break;case"middle":a=.5;break;case"bottom":a=1;break;default:a=n[0]/o.height}switch(n[1]){case"left":r=0;break;case"center":r=.5;break;case"right":r=1;break;default:r=n[1]/o.width}return{x:r,y:a}},createPlaceholder:function(n){var o,a=n.css("position"),r=n.position();return n.css({marginTop:n.css("marginTop"),marginBottom:n.css("marginBottom"),marginLeft:n.css("marginLeft"),marginRight:n.css("marginRight")}).outerWidth(n.outerWidth()).outerHeight(n.outerHeight()),/^(static|relative)/.test(a)&&(a="absolute",o=s("<"+n[0].nodeName+">").insertAfter(n).css({display:/^(inline|ruby)/.test(n.css("display"))?"inline-block":"block",visibility:"hidden",marginTop:n.css("marginTop"),marginBottom:n.css("marginBottom"),marginLeft:n.css("marginLeft"),marginRight:n.css("marginRight"),float:n.css("float")}).outerWidth(n.outerWidth()).outerHeight(n.outerHeight()).addClass("ui-effects-placeholder"),n.data(J+"placeholder",o)),n.css({position:a,left:r.left,top:r.top}),o},removePlaceholder:function(n){var o=J+"placeholder",a=n.data(o);a&&(a.remove(),n.removeData(o))},cleanUp:function(n){s.effects.restoreStyle(n),s.effects.removePlaceholder(n)},setTransition:function(n,o,a,r){return r=r||{},s.each(o,function(l,h){var u=n.cssUnit(h);u[0]>0&&(r[h]=u[0]*a+u[1])}),r}});function t(n,o,a,r){return s.isPlainObject(n)&&(o=n,n=n.effect),n={effect:n},o==null&&(o={}),s.isFunction(o)&&(r=o,a=null,o={}),(typeof o=="number"||s.fx.speeds[o])&&(r=a,a=o,o={}),s.isFunction(a)&&(r=a,a=null),o&&s.extend(n,o),a=a||o.duration,n.duration=s.fx.off?0:typeof a=="number"?a:a in s.fx.speeds?s.fx.speeds[a]:s.fx.speeds._default,n.complete=r||o.complete,n}function e(n){return!!(!n||typeof n=="number"||s.fx.speeds[n]||typeof n=="string"&&!s.effects.effect[n]||s.isFunction(n)||typeof n=="object"&&!n.effect)}s.fn.extend({effect:function(){var n=t.apply(this,arguments),o=s.effects.effect[n.effect],a=o.mode,r=n.queue,l=r||"fx",h=n.complete,u=n.mode,d=[],g=function(p){var m=s(this),f=s.effects.mode(m,u)||a;m.data(tt,!0),d.push(f),a&&(f==="show"||f===a&&f==="hide")&&m.show(),(!a||f!=="none")&&s.effects.saveStyle(m),s.isFunction(p)&&p()};if(s.fx.off||!o)return u?this[u](n.duration,h):this.each(function(){h&&h.call(this)});function c(p){var m=s(this);function f(){m.removeData(tt),s.effects.cleanUp(m),n.mode==="hide"&&m.hide(),_()}function _(){s.isFunction(h)&&h.call(m[0]),s.isFunction(p)&&p()}n.mode=d.shift(),s.uiBackCompat!==!1&&!a?(m.is(":hidden")?u==="hide":u==="show")?(m[u](),_()):o.call(m[0],n,_):n.mode==="none"?(m[u](),_()):o.call(m[0],n,f)}return r===!1?this.each(g).each(c):this.queue(l,g).queue(l,c)},show:function(n){return function(o){if(e(o))return n.apply(this,arguments);var a=t.apply(this,arguments);return a.mode="show",this.effect.call(this,a)}}(s.fn.show),hide:function(n){return function(o){if(e(o))return n.apply(this,arguments);var a=t.apply(this,arguments);return a.mode="hide",this.effect.call(this,a)}}(s.fn.hide),toggle:function(n){return function(o){if(e(o)||typeof o=="boolean")return n.apply(this,arguments);var a=t.apply(this,arguments);return a.mode="toggle",this.effect.call(this,a)}}(s.fn.toggle),cssUnit:function(n){var o=this.css(n),a=[];return s.each(["em","px","%","pt"],function(r,l){o.indexOf(l)>0&&(a=[parseFloat(o),l])}),a},cssClip:function(n){return n?this.css("clip","rect("+n.top+"px "+n.right+"px "+n.bottom+"px "+n.left+"px)"):i(this.css("clip"),this)},transfer:function(n,o){var a=s(this),r=s(n.to),l=r.css("position")==="fixed",h=s("body"),u=l?h.scrollTop():0,d=l?h.scrollLeft():0,g=r.offset(),c={top:g.top-u,left:g.left-d,height:r.innerHeight(),width:r.innerWidth()},p=a.offset(),m=s("<div class='ui-effects-transfer'></div>").appendTo("body").addClass(n.className).css({top:p.top-u,left:p.left-d,height:a.innerHeight(),width:a.innerWidth(),position:l?"fixed":"absolute"}).animate(c,n.duration,n.easing,function(){m.remove(),s.isFunction(o)&&o()})}});function i(n,o){var a=o.outerWidth(),r=o.outerHeight(),l=/^rect\((-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto)\)$/,h=l.exec(n)||["",0,a,r,0];return{top:parseFloat(h[1])||0,right:h[2]==="auto"?a:parseFloat(h[2]),bottom:h[3]==="auto"?r:parseFloat(h[3]),left:parseFloat(h[4])||0}}s.fx.step.clip=function(n){n.clipInit||(n.start=s(n.elem).cssClip(),typeof n.end=="string"&&(n.end=i(n.end,n.elem)),n.clipInit=!0),s(n.elem).cssClip({top:n.pos*(n.end.top-n.start.top)+n.start.top,right:n.pos*(n.end.right-n.start.right)+n.start.right,bottom:n.pos*(n.end.bottom-n.start.bottom)+n.start.bottom,left:n.pos*(n.end.left-n.start.left)+n.start.left})}}(),function(){var t={};s.each(["Quad","Cubic","Quart","Quint","Expo"],function(e,i){t[i]=function(n){return Math.pow(n,e+2)}}),s.extend(t,{Sine:function(e){return 1-Math.cos(e*Math.PI/2)},Circ:function(e){return 1-Math.sqrt(1-e*e)},Elastic:function(e){return e===0||e===1?e:-Math.pow(2,8*(e-1))*Math.sin(((e-1)*80-7.5)*Math.PI/15)},Back:function(e){return e*e*(3*e-2)},Bounce:function(e){for(var i,n=4;e<((i=Math.pow(2,--n))-1)/11;);return 1/Math.pow(4,3-n)-7.5625*Math.pow((i*3-2)/22-e,2)}}),s.each(t,function(e,i){s.easing["easeIn"+e]=i,s.easing["easeOut"+e]=function(n){return 1-i(1-n)},s.easing["easeInOut"+e]=function(n){return n<.5?i(n*2)/2:1-i(n*-2+2)/2}})}();var et=s.effects;/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var It=s.effects.define("bounce",function(t,e){var i,n,o,a=s(this),r=t.mode,l=r==="hide",h=r==="show",u=t.direction||"up",d=t.distance,g=t.times||5,c=g*2+(h||l?1:0),p=t.duration/c,m=t.easing,f=u==="up"||u==="down"?"top":"left",_=u==="up"||u==="left",v=0,b=a.queue().length;for(s.effects.createPlaceholder(a),o=a.css(f),d||(d=a[f==="top"?"outerHeight":"outerWidth"]()/3),h&&(n={opacity:1},n[f]=o,a.css("opacity",0).css(f,_?-d*2:d*2).animate(n,p,m)),l&&(d=d/Math.pow(2,g-1)),n={},n[f]=o;v<g;v++)i={},i[f]=(_?"-=":"+=")+d,a.animate(i,p,m).animate(n,p,m),d=l?d*2:d/2;l&&(i={opacity:0},i[f]=(_?"-=":"+=")+d,a.animate(i,p,m)),a.queue(e),s.effects.unshift(a,b,c+1)});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Pt=s.effects.define("drop","hide",function(t,e){var i,n=s(this),o=t.mode,a=o==="show",r=t.direction||"left",l=r==="up"||r==="down"?"top":"left",h=r==="up"||r==="left"?"-=":"+=",u=h==="+="?"-=":"+=",d={opacity:0};s.effects.createPlaceholder(n),i=t.distance||n[l==="top"?"outerHeight":"outerWidth"](!0)/2,d[l]=h+i,a&&(n.css(d),d[l]=u+i,d.opacity=1),n.animate(d,{queue:!1,duration:t.duration,easing:t.easing,complete:e})});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Mt=s.effects.define("explode","hide",function(t,e){var i,n,o,a,r,l,h=t.pieces?Math.round(Math.sqrt(t.pieces)):3,u=h,d=s(this),g=t.mode,c=g==="show",p=d.show().css("visibility","hidden").offset(),m=Math.ceil(d.outerWidth()/u),f=Math.ceil(d.outerHeight()/h),_=[];function v(){_.push(this),_.length===h*u&&b()}for(i=0;i<h;i++)for(a=p.top+i*f,l=i-(h-1)/2,n=0;n<u;n++)o=p.left+n*m,r=n-(u-1)/2,d.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-n*m,top:-i*f}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:m,height:f,left:o+(c?r*m:0),top:a+(c?l*f:0),opacity:c?0:1}).animate({left:o+(c?0:r*m),top:a+(c?0:l*f),opacity:c?1:0},t.duration||500,t.easing,v);function b(){d.css({visibility:"visible"}),s(_).remove(),e()}});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var St=s.effects.define("fade","toggle",function(t,e){var i=t.mode==="show";s(this).css("opacity",i?0:1).animate({opacity:i?1:0},{queue:!1,duration:t.duration,easing:t.easing,complete:e})});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Ht=s.effects.define("fold","hide",function(t,e){var i=s(this),n=t.mode,o=n==="show",a=n==="hide",r=t.size||15,l=/([0-9]+)%/.exec(r),h=!!t.horizFirst,u=h?["right","bottom"]:["bottom","right"],d=t.duration/2,g=s.effects.createPlaceholder(i),c=i.cssClip(),p={clip:s.extend({},c)},m={clip:s.extend({},c)},f=[c[u[0]],c[u[1]]],_=i.queue().length;l&&(r=parseInt(l[1],10)/100*f[a?0:1]),p.clip[u[0]]=r,m.clip[u[0]]=r,m.clip[u[1]]=0,o&&(i.cssClip(m.clip),g&&g.css(s.effects.clipToBox(m)),m.clip=c),i.queue(function(v){g&&g.animate(s.effects.clipToBox(p),d,t.easing).animate(s.effects.clipToBox(m),d,t.easing),v()}).animate(p,d,t.easing).animate(m,d,t.easing).queue(e),s.effects.unshift(i,_,4)});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Ot=s.effects.define("highlight","show",function(t,e){var i=s(this),n={backgroundColor:i.css("backgroundColor")};t.mode==="hide"&&(n.opacity=0),s.effects.saveStyle(i),i.css({backgroundImage:"none",backgroundColor:t.color||"#ffff99"}).animate(n,{queue:!1,duration:t.duration,easing:t.easing,complete:e})});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Nt=s.effects.define("puff","hide",function(t,e){var i=s.extend(!0,{},t,{fade:!0,percent:parseInt(t.percent,10)||150});s.effects.effect.scale.call(this,i,e)});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Et=s.effects.define("pulsate","show",function(t,e){var i=s(this),n=t.mode,o=n==="show",a=n==="hide",r=o||a,l=(t.times||5)*2+(r?1:0),h=t.duration/l,u=0,d=1,g=i.queue().length;for((o||!i.is(":visible"))&&(i.css("opacity",0).show(),u=1);d<l;d++)i.animate({opacity:u},h,t.easing),u=1-u;i.animate({opacity:u},h,t.easing),i.queue(e),s.effects.unshift(i,g,l+1)});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Wt=s.effects.define("shake",function(t,e){var i=1,n=s(this),o=t.direction||"left",a=t.distance||20,r=t.times||3,l=r*2+1,h=Math.round(t.duration/l),u=o==="up"||o==="down"?"top":"left",d=o==="up"||o==="left",g={},c={},p={},m=n.queue().length;for(s.effects.createPlaceholder(n),g[u]=(d?"-=":"+=")+a,c[u]=(d?"+=":"-=")+a*2,p[u]=(d?"-=":"+=")+a*2,n.animate(g,h,t.easing);i<r;i++)n.animate(c,h,t.easing).animate(p,h,t.easing);n.animate(c,h,t.easing).animate(g,h/2,t.easing).queue(e),s.effects.unshift(n,m,l+1)});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Ft=s.effects.define("slide","show",function(t,e){var i,n,o=s(this),a={up:["bottom","top"],down:["top","bottom"],left:["right","left"],right:["left","right"]},r=t.mode,l=t.direction||"left",h=l==="up"||l==="down"?"top":"left",u=l==="up"||l==="left",d=t.distance||o[h==="top"?"outerHeight":"outerWidth"](!0),g={};s.effects.createPlaceholder(o),i=o.cssClip(),n=o.position()[h],g[h]=(u?-1:1)*d+n,g.clip=o.cssClip(),g.clip[a[l][1]]=g.clip[a[l][0]],r==="show"&&(o.cssClip(g.clip),o.css(h,g[h]),g.clip=i,g[h]=n),o.animate(g,{queue:!1,duration:t.duration,easing:t.easing,complete:e})});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var et;s.uiBackCompat!==!1&&(et=s.effects.define("transfer",function(t,e){s(this).transfer(t,e)}));var Lt=et;/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */s.ui.focusable=function(t,e){var i,n,o,a,r,l=t.nodeName.toLowerCase();return l==="area"?(i=t.parentNode,n=i.name,!t.href||!n||i.nodeName.toLowerCase()!=="map"?!1:(o=s("img[usemap='#"+n+"']"),o.length>0&&o.is(":visible"))):(/^(input|select|textarea|button|object)$/.test(l)?(a=!t.disabled,a&&(r=s(t).closest("fieldset")[0],r&&(a=!r.disabled))):l==="a"?a=t.href||e:a=e,a&&s(t).is(":visible")&&gt(s(t)))};function gt(t){for(var e=t.css("visibility");e==="inherit";)t=t.parent(),e=t.css("visibility");return e!=="hidden"}s.extend(s.expr[":"],{focusable:function(t){return s.ui.focusable(t,s.attr(t,"tabindex")!=null)}});var Rt=s.ui.focusable,Bt=s.fn.form=function(){return typeof this[0].form=="string"?this.closest("form"):s(this[0].form)};/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var qt=s.ui.keyCode={BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38},Kt=s.ui.escapeSelector=function(){var t=/([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g;return function(e){return e.replace(t,"\\$1")}}();/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Ut=s.fn.labels=function(){var t,e,i,n,o;return this[0].labels&&this[0].labels.length?this.pushStack(this[0].labels):(n=this.eq(0).parents("label"),i=this.attr("id"),i&&(t=this.eq(0).parents().last(),o=t.add(t.length?t.siblings():this.siblings()),e="label[for='"+s.ui.escapeSelector(i)+"']",n=n.add(o.find(e).addBack(e))),this.pushStack(n))};/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var Xt=s.extend(s.expr[":"],{tabbable:function(t){var e=s.attr(t,"tabindex"),i=e!=null;return(!i||e>=0)&&s.ui.focusable(t,i)}});/*!
 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */var jt=s.fn.extend({uniqueId:function(){var t=0;return function(){return this.each(function(){this.id||(this.id="ui-id-"+ ++t)})}}(),removeUniqueId:function(){return this.each(function(){/^ui-id-\d+$/.test(this.id)&&s(this).removeAttr("id")})}});/*!
